...
use GlobalVisa\Repositories\Translate;
...
class CopydataController extends ControllerBase
{
    ...
    {
        $arrayTable = array(
            'new_article' => 'GlobalVisa\Models\VisaArticle',
            'new_type' => 'GlobalVisa\Models\VisaType',
            'new_page' => 'GlobalVisa\Models\VisaPage',
              );
        $arrayTableLang = array(
            'new_article_lang' => 'GlobalVisa\Models\VisaArticleLang',
            'new_type_lang' => 'GlobalVisa\Models\VisaTypeLang',
            'new_page_lang' => 'GlobalVisa\Models\VisaPageLang',
        );
        $response = $arrayTable;
        if ($type == 'full') {
