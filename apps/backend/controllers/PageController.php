...
use GlobalVisa\Models\VisaPage;
use GlobalVisa\Models\VisaPageLang;
use GlobalVisa\Repositories\Country;
use GlobalVisa\Repositories\CountryGeneral;
use GlobalVisa\Repositories\Location;
use GlobalVisa\Repositories\Page;
use GlobalVisa\Repositories\PageLang;
...
//                        }
    ...
    private function getParameter($location_country_code, $selectAll = '')
    {
        ...
        if ($langCode === $this->globalVariable->defaultLanguage) {
            $sql = "SELECT p.* FROM GlobalVisa\Models\VisaPage p WHERE 1";
            if (!empty($keyword)) {
            ...
            $sql = "SELECT p.*, pl.* FROM GlobalVisa\Models\VisaPage p 
                    INNER JOIN \GlobalVisa\Models\VisaPageLang pl
