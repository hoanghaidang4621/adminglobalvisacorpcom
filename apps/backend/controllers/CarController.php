...
use GlobalVisa\Models\VisaCarLang;
use Phalcon\Paginator\Adapter\Model as PaginatorModel;
use GlobalVisa\Repositories\Language;
use GlobalVisa\Repositories\Car;
use GlobalVisa\Repositories\CarLang;
...
class CarController extends ControllerBase
{
    ...
    private function getParameter()
    {
        ...
        $arrParameter = [];
        $sql = "SELECT * FROM GlobalVisa\Models\VisaCar AS m WHERE 1 ";
        if (!empty($keyword)) {
