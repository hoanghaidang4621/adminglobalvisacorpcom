...
use GlobalVisa\Repositories\Newspaper;
use GlobalVisa\Models\VisaNewspaperArticle;
use GlobalVisa\Repositories\NewspaperArticle;
...
class NewspaperarticleController extends ControllerBase
{
    ...
    private function getParameter(){
        $sql = "SELECT * FROM GlobalVisa\Models\VisaNewspaperArticle WHERE 1";
