...
use GlobalVisa\Models\VisaArticle;
use GlobalVisa\Models\VisaArticleLang;
use GlobalVisa\Models\VisaLanguage;
use GlobalVisa\Repositories\Country;
use GlobalVisa\Repositories\CountryGeneral;
use GlobalVisa\Repositories\Location;
use GlobalVisa\Repositories\Type;
use GlobalVisa\Repositories\Article;
use GlobalVisa\Repositories\ArticleLang;
...
class ArticleController extends ControllerBase
{
    ...
    private function getParameter($location_country_code, $selectAll = '')
    {
        ...
        if ($langCode === $this->globalVariable->defaultLanguage) {
            $sql = "SELECT a.* FROM GlobalVisa\Models\VisaArticle as a 
            WHERE 1";
            if (!empty($keyword)) {
            ...
            $sql = "SELECT a.*, al.* FROM GlobalVisa\Models\VisaArticle a 
                    INNER JOIN \GlobalVisa\Models\VisaArticleLang al
