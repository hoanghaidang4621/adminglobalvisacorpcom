...
use GlobalVisa\Utils\BinCodes;
use GlobalVisa\Utils\IpApi;

class VisaPaymentBin extends \Phalcon\Mvc\Model
{
    ...
    /**
     * @param BinCodes $binCodeInfo
     * @param IpApi $ipInfo
     */
    public function setWithBinCodeInfo($binCodeInfo = null, $ipInfo = null)
    {
    ...
    /**
     * Method to set the value of field bin_payment_id
     *
     * @param integer $bin_payment_id
     * @return $this
     */
    public function setBinPaymentId($bin_payment_id)
    {
        $this->bin_payment_id = $bin_payment_id;
    ...
    /**
     * Returns the value of field bin_payment_id
     *
     * @return integer
     */
    public function getBinPaymentId()
    {
        return $this->bin_payment_id;
    }
