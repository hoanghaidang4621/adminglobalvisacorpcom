...
class NewProcessingFee extends BaseModel
{
     ...
     * @Column(type="integer", length=11, nullable=false)
     */
    protected $processing_arrival_id;
    ...
    /**
     * Method to set the value of field processing_arrival_id
     *
     * @param integer $processing_arrival_id
     * @return $this
     */
    public function setProcessingArrivalId($processing_arrival_id)
    {
        $this->processing_arrival_id = $processing_arrival_id;
    ...
    /**
     * Returns the value of field processing_arrival_id
     *
     * @return integer
     */
    public function getProcessingArrivalId()
    {
        return $this->processing_arrival_id;
    }
     ...
     * @return NewProcessingFee[]|NewProcessingFee
     */
