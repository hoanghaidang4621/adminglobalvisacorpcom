...
use GlobalVisa\Models\VisaLocation;
use Phalcon\Di;
...
class Location extends Component
{
    ...
    public static function findLanguageByCountryCode($country_code)
    {
        ...
        $sql = 'SELECT * FROM GlobalVisa\Models\VisaLanguage WHERE language_code IN 
                    (SELECT location_lang_code FROM  GlobalVisa\Models\VisaLocation WHERE  location_active= "Y" AND location_country_code = :country_code:)';
    ...
    public static function findAllLocation($location_from_id,$lang_from_code)
    {
        $model = VisaLocation::query()->columns('location_id , location_country_code, location_lang_code, ct.country_name, lg.language_name')
            ->innerJoin('GlobalVisa\Models\VisaCountry', 'LOWER(ct.country_code) = location_country_code', 'ct')
            ->innerJoin('GlobalVisa\Models\VisaLanguage', 'LOWER(lg.language_code) = location_lang_code', 'lg')
    ...
    public static function getCountryGlobalComboBox($country_code)
    {
        ...
        $modelsManager = Di::getDefault()->get('modelsManager');
        $sql = 'SELECT * FROM \GlobalVisa\Models\VisaCountry WHERE  country_code IN 
                    (SELECT DISTINCT location_country_code FROM  \GlobalVisa\Models\VisaLocation WHERE location_active= "Y"  )';
    ...
    {
        $modelsManager = Di::getDefault()->get('modelsManager');
        $sql = 'SELECT lo.location_lang_code, la.language_name FROM \GlobalVisa\Models\VisaLocation AS lo
                LEFT JOIN \GlobalVisa\Models\VisaLanguage AS la 
